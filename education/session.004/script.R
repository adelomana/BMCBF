...
#
# this is required to make differential calling at the gene level instead of the transcript level
...
# run the test. LRT and Wald tests are available, more info here: https://hbctraining.github.io/DGE_workshop_salmon/lessons/08_DGE_LRT.html
