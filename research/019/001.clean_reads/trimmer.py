...
def trimmomatic_caller(sample):
    ...
    printt('working with sample {}'.format(sample))
    ...
    input1 = raw_fastq_dir + sample + '/' + working_files[0]
    input2 = raw_fastq_dir + sample + '/' + working_files[1]

    output1 = output_dir + sample + '_' + working_label + 'R1_clean.fastq.gz'
    output2 = output_dir + sample + '_' + working_label + 'R2_clean.fastq.gz'

    garbage1 = output_dir + sample + '_' + working_label + 'R1_garbage.fastq.gz'
    garbage2 = output_dir + sample + '_' + working_label + 'R2_garbage.fastq.gz'
    ...
    printt('about to clean {}'.format(working_label))
    print('')
    print(command)
    print('')
    os.system(command)
...
#
raw_fastq_dir = '/Users/adrian/Nextcloud/door2necio5/019/'
clean_fastq_dir = '/Volumes/sandbox/'
