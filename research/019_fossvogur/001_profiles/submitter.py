...
date
cp -rf /hpcdata/Mimir/adrian/entrance2nextcloud/019/{} $tdir/.
date
...
date
mkdir /hpcdata/Mimir/adrian/research/019/{}_processed
cp -rf kallisto_output_* /hpcdata/Mimir/adrian/research/019/{}_processed/.
date
