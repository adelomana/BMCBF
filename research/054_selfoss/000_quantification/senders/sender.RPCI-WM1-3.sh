...
#SBATCH --job-name=RPCI-WM1-3
#SBATCH --partition=mimir-interactive
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16       
#SBATCH --hint=multithread        
#SBATCH --output=messages/messages.RPCI-WM1-3.out.txt   
#SBATCH --error=messages/messages.RPCI-WM1-3.err.txt 
...
date
cp -rf /hpcdata/Mimir/shared/adrian/2025.08.26_adrian2erna/rnaseq/F25A910000195_ANIytzuT/RPCI-WM1-3 $tdir/.
date
...
ls
date
time /users/home/adrian/software/fastp/fastp -i RPCI-WM1-3_1.fq.gz -I RPCI-WM1-3_2.fq.gz -o clean.R1.fq.gz -O clean.R2.fq.gz --thread 16 --detect_adapter_for_pe --trim_poly_g --trim_poly_x --cut_tail --cut_window_size 4 --cut_mean_quality 20 --length_required 36 --thread 16 -h report.html -j report.json
date
...
ls
date
mkdir /hpcdata/Mimir/shared/adrian/2025.09.12_adrian2julia/RPCI-WM1-3_processed
cp -rf kallisto_output_* /hpcdata/Mimir/shared/adrian/2025.09.12_adrian2julia/RPCI-WM1-3_processed/.
cp -rf report* /hpcdata/Mimir/shared/adrian/2025.09.12_adrian2julia/RPCI-WM1-3_processed/.
date
