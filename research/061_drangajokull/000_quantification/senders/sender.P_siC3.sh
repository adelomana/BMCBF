...
#SBATCH --job-name=P_siC3
#SBATCH --partition=mimir
#SBATCH --nodes=1            
#SBATCH --ntasks-per-node=8
#SBATCH --hint=nomultithread  
#SBATCH --output=messages/messages.P_siC3.out.txt   
#SBATCH --error=messages/messages.P_siC3.err.txt 
...
date
cp -rf /hpcdata/Mimir/adrian/research/061_drangajokull/data/P_siC3 $tdir/.
date
...
ls
date
time /users/home/adrian/software/fastp/fastp -i /hpcdata/Mimir/adrian/research/061_drangajokull/data/P_siC3/P_siC3_MKRN250061806-1A_233KYFLT4_L6_1.fq.gz -I /hpcdata/Mimir/adrian/research/061_drangajokull/data/P_siC3/P_siC3_MKRN250061806-1A_233KYFLT4_L6_2.fq.gz -o P_siC3_part1.clean.R1.fq.gz -O P_siC3_part1.clean.R2.fq.gz --thread 16 --detect_adapter_for_pe --trim_poly_g --trim_poly_x --cut_tail --cut_window_size 4 --cut_mean_quality 20 --length_required 36 -h P_siC3_part1.fastp.html -j P_siC3_part1.fastp.json
date
...
ls
date
mkdir /hpcdata/Mimir/adrian/research/061_drangajokull/results/P_siC3_processed
cp -rf kallisto_output_* /hpcdata/Mimir/adrian/research/061_drangajokull/results/P_siC3_processed/.
cp -rf report* /hpcdata/Mimir/adrian/research/061_drangajokull/results/P_siC3_processed/.
date
