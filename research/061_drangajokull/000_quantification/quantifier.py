...
def launcher(sample):
    ...
    r1_files = sorted(f for f in working_files if "_1.f" in f)
    r2_files = sorted(f for f in working_files if "_2.f" in f)
...
#
raw_fastq_dir = '/hpcdata/Mimir/adrian/research/061_drangajokull/data/'
results_dir = '/hpcdata/Mimir/adrian/research/061_drangajokull/results/'
