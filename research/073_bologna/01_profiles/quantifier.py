...
cp *fastp.html {results_dir}{sample}_processed/.
date
...
#
raw_fastq_dir = '/hpcdata/Mimir/adrian/research/073_bologna/data/'
results_dir = '/hpcdata/Mimir/adrian/research/073_bologna/results/'
