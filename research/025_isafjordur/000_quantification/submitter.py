...
date
cp -rf /hpcdata/Mimir/adrian/research/025.isafjordur/deCODE_Kritika/{} $tdir/.
date
...
date
mkdir /hpcdata/Mimir/adrian/research/025.isafjordur/deCODE_Kritika/{}_processed
cp -rf kallisto_output_* /hpcdata/Mimir/adrian/research/025.isafjordur/deCODE_Kritika/{}_processed/.
date
...
date
    ...
    """.format(sample, sample, sample, sample, command, kallisto_cmd_a, kallisto_cmd_b, kallisto_cmd_c, sample, sample)
...
#
raw_fastq_dir = '/hpcdata/Mimir/adrian/research/025.isafjordur/deCODE_Kritika/'
