...
#
setwd("~/scratch/")
kallisto_dir = "/Users/adrian/research/bmcbf/079/results/profiles"
results_dir = '/Users/adrian/research/bmcbf/079/results/degs'
...
metadata$treatment = c(rep('ctl', 3), rep('tre', 3))
View(metadata)
