...
#
setwd("~/scratch/")
kallisto_dir = "/Users/adrian/research/bmcbf/080/results/profiles"
results_dir = '/Users/adrian/research/bmcbf/080/results/degs'
...
paths = file.path(dirnames, paste0("kallisto_output_", labels, "_reverse"), 'abundance.h5')
metadata$path = paths

metadata$treatment = c(rep('wt', 4), rep('ko', 3))
View(metadata)
