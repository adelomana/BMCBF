...
# Parameters
GSE_ID = "GSE152991"
OUTDIR = "/hpcdata/Mimir/adrian/research/044_vala_GSE/data/"
...
# read info
#
srr_df = pandas.read_csv('info.tsv', sep='\t')
...
for index, row in srr_df.iterrows():
    ...
    # create sender
    SRA_DIR = f"/hpcdata/Mimir/adrian/research/044_vala_GSE/{srr}/"
    sra_file = os.path.join(SRA_DIR, f"{srr}.sra")
