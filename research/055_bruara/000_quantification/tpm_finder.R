...
results_dir = "/Users/adrian/research/bmcbf/055_bruara/results/transcriptomics/profiles"
...
df = read.csv('/Users/adrian/software/kallisto/zebrafish_index_standard/t2g.txt', sep='\t', header=FALSE)
t2g = df
View(t2g)
dim(t2g)
