...
#SBATCH --job-name=R_AM_Trans_1
#SBATCH --partition=mimir
#SBATCH --nodes=1            
#SBATCH --ntasks-per-node=8
#SBATCH --hint=nomultithread  
#SBATCH --output=messages/messages.R_AM_Trans_1.out.txt   
#SBATCH --error=messages/messages.R_AM_Trans_1.err.txt 
...
date
cp -rf /hpcdata/Mimir/adrian/research/055_bruara/data/rnaseq/R_AM_Trans_1 $tdir/.
date
...
cd $tdir/R_AM_Trans_1
ls
date
time /users/home/adrian/software/fastp/fastp -i R_AM_Trans_1_1.fq.gz -I R_AM_Trans_1_2.fq.gz -o clean.R1.fq.gz -O clean.R2.fq.gz --thread 16 --detect_adapter_for_pe --trim_poly_g --trim_poly_x --cut_tail --cut_window_size 4 --cut_mean_quality 20 --length_required 36 --thread 16 -h report.html -j report.json
date
...
ls
date
mkdir /hpcdata/Mimir/adrian/research/055_bruara/results/rnaseq/R_AM_Trans_1_processed
cp -rf kallisto_output_* /hpcdata/Mimir/adrian/research/055_bruara/results/rnaseq/R_AM_Trans_1_processed/.
cp -rf report* /hpcdata/Mimir/adrian/research/055_bruara/results/rnaseq/R_AM_Trans_1_processed/.
date
