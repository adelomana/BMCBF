...
date
cp -rf /hpcdata/Mimir/adrian/research/keilir/data/000_trimmed/MITF_A_Untreated_FLAG_1 $tdir/.
date
...
date
cp -rf *.bam /hpcdata/Mimir/adrian/research/keilir/results/MITF_A_Untreated_FLAG_1/.
date
