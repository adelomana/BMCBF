...
date
cp -rf /hpcdata/Mimir/adrian/research/keilir/data/000_trimmed/MITF_M_Untreated_IgG_3 $tdir/.
date
...
date
cp -rf *.bam /hpcdata/Mimir/adrian/research/keilir/results/MITF_M_Untreated_IgG_3/.
date
