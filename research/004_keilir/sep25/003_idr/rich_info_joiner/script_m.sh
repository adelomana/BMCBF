...
# -------- CONFIG --------
BASE="/hpcdata/Mimir/adrian/research/004_keilir/results/idr/MITF_M"
CONS="${BASE}/MITF_M.IDR_consensus.bed"
...
# Output file
OUT="${BASE}/MITF_M.IDR_consensus.with_FE_q.${WITHIN_REP_AGG}_within.${ACROSS_REP_AGG}_across.tsv"
# -------------------------
