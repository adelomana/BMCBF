...
date
cp -rf report* /hpcdata/Mimir/adrian/research/keilir/results/MITF_M_Untreated_IgG_1/.
cp -rf human.bam /hpcdata/Mimir/adrian/research/keilir/results/MITF_M_Untreated_IgG_1/.
date
