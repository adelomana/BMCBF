...
date
cp -rf report* /hpcdata/Mimir/adrian/research/keilir/results/MITF_M_Untreated_FLAG_3/.
cp -rf human.bam /hpcdata/Mimir/adrian/research/keilir/results/MITF_M_Untreated_FLAG_3/.
date
