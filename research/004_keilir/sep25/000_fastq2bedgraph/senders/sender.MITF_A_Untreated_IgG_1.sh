...
date
time /users/home/adrian/software/java/jdk-21.0.8/bin/java -jar /users/home/adrian/software/picard/picard.jar AddOrReplaceReadGroups I=human.bam O=human.RG.bam RGID=MITF_A_Untreated_IgG_1 RGLB=lib_MITF_A_Untreated_IgG_1 RGPL=ILLUMINA RGPU=unit1 RGSM=MITF_A_Untreated_IgG_1 VERBOSITY=WARNING
date
...
date
time /users/home/adrian/software/java/jdk-21.0.8/bin/java -jar /users/home/adrian/software/picard/picard.jar MarkDuplicates I=human.RG.bam O=human.RG.marked_dup.bam REMOVE_DUPLICATES=true M=MITF_A_Untreated_IgG_1.marked_dup.info.txt VERBOSITY=WARNING
date
...
date
cp fragment_length_info.txt /hpcdata/Mimir/adrian/research/keilir/results/MITF_A_Untreated_IgG_1/.
cp human.fragments.500.bed /hpcdata/Mimir/adrian/research/keilir/results/MITF_A_Untreated_IgG_1/.
cp human.bedgraph /hpcdata/Mimir/adrian/research/keilir/results/MITF_A_Untreated_IgG_1/.
date
