...
#SBATCH --job-name=MITF_M_Untreated_IgG_2
#SBATCH --partition=mimir
#SBATCH --nodes=1            
#SBATCH --ntasks-per-node=16    
#SBATCH --hint=nomultithread       
#SBATCH --output=messages/messages.MITF_M_Untreated_IgG_2.out.txt   
#SBATCH --error=messages/messages.MITF_M_Untreated_IgG_2.err.txt 
...
date
cp -rf /hpcdata/Mimir/adrian/door/MITF_M_Untreated_IgG_2 $tdir/.
date
cd $tdir
cd MITF_M_Untreated_IgG_2
...
date
time fastp -i novaseqxplus4_20240513_LH00203_0044_A22F577LT3.s_3_1705_1505.001.R1.fastq.gz -I novaseqxplus4_20240513_LH00203_0044_A22F577LT3.s_3_1705_1505.001.R2.fastq.gz -o clean.R1.fq.gz -O clean.R2.fq.gz --thread 32 --trim_poly_g --detect_adapter_for_pe --allow_gap_overlap_trimming --length_required 25 -h report.html -j report.json
date
...
date
time /users/home/adrian/software/java/jdk-21.0.8/bin/java -jar /users/home/adrian/software/picard/picard.jar AddOrReplaceReadGroups I=human.bam O=human.RG.bam RGID=MITF_M_Untreated_IgG_2 RGLB=lib_MITF_M_Untreated_IgG_2 RGPL=ILLUMINA RGPU=unit2 RGSM=MITF_M_Untreated_IgG_2 VERBOSITY=WARNING
date
...
date
time /users/home/adrian/software/java/jdk-21.0.8/bin/java -jar /users/home/adrian/software/picard/picard.jar MarkDuplicates I=human.RG.bam O=human.RG.marked_dup.bam REMOVE_DUPLICATES=true M=MITF_M_Untreated_IgG_2.marked_dup.info.txt VERBOSITY=WARNING
date
...
ls -ltrsah
mkdir /hpcdata/Mimir/adrian/research/keilir/results/MITF_M_Untreated_IgG_2

date
cp fragment_length_info.txt /hpcdata/Mimir/adrian/research/keilir/results/MITF_M_Untreated_IgG_2/.
cp human.fragments.500.bed /hpcdata/Mimir/adrian/research/keilir/results/MITF_M_Untreated_IgG_2/.
cp human.bedgraph /hpcdata/Mimir/adrian/research/keilir/results/MITF_M_Untreated_IgG_2/.
date
