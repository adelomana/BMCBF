...
write.table(sorted_filtred_results, file=paste(results_dir, '/effect_D060_vs_control.dog.tsv', sep=''), quote=FALSE, sep='\t')
write.table(anti_results, file=paste(results_dir, '/effect_D060_vs_control.anti.dog.tsv', sep=''), quote=FALSE, sep='\t')
...
write.table(sorted_filtred_results, file=paste(results_dir, '/effect_D120_vs_control.dog.tsv', sep=''), quote=FALSE, sep='\t')
write.table(anti_results, file=paste(results_dir, '/effect_D120_vs_control.anti.dog.tsv', sep=''), quote=FALSE, sep='\t')
...
write.table(sorted_filtred_results, file=paste(results_dir, '/effect_D240_vs_control.dog.tsv', sep=''), quote=FALSE, sep='\t')
write.table(anti_results, file=paste(results_dir, '/effect_D240_vs_control.anti.dog.tsv', sep=''), quote=FALSE, sep='\t')
